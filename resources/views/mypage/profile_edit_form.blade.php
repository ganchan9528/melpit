...
@section('content')
<div id="profile-eidt-form" class="container">
	<div class="row">
...
<div class="row">
	<div class="col-8 offset-2 bg-white">
		...
		<div class="font-weight-bold text-center border-bottom pd-3 pt-3" style="font-size: 24px">プロフィール編集</div>
